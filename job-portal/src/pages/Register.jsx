...
const Register = () => {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gradient-to-r from-blue to-blue-500">
      <div className="w-full max-w-sm p-8 bg-white rounded-2xl shadow-lg">
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <button
            type="submit"
            className="w-full py-2 mt-4 text-white bg-blue rounded-md hover:bg-green-600 transition-colors"
          >
            Register
          </button>
        </form>
